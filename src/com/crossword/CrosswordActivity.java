...
public class CrosswordActivity extends Activity implements OnClickListener  {
	...
	final static private int[][] GRID_ID = {
		{R.id.area_1_1, R.id.area_1_2, R.id.area_1_3, R.id.area_1_4, R.id.area_1_5, R.id.area_1_6, R.id.area_1_7, R.id.area_1_8, R.id.area_1_9},
		{R.id.area_2_1, R.id.area_2_2, R.id.area_2_3, R.id.area_2_4, R.id.area_2_5, R.id.area_2_6, R.id.area_2_7, R.id.area_2_8, R.id.area_2_9},
		{R.id.area_3_1, R.id.area_3_2, R.id.area_3_3, R.id.area_3_4, R.id.area_3_5, R.id.area_3_6, R.id.area_3_7, R.id.area_3_8, R.id.area_3_9},
		{R.id.area_4_1, R.id.area_4_2, R.id.area_4_3, R.id.area_4_4, R.id.area_4_5, R.id.area_4_6, R.id.area_4_7, R.id.area_4_8, R.id.area_4_9},
		{R.id.area_5_1, R.id.area_5_2, R.id.area_5_3, R.id.area_5_4, R.id.area_5_5, R.id.area_5_6, R.id.area_5_7, R.id.area_5_8, R.id.area_5_9},
		{R.id.area_6_1, R.id.area_6_2, R.id.area_6_3, R.id.area_6_4, R.id.area_6_5, R.id.area_6_6, R.id.area_6_7, R.id.area_6_8, R.id.area_6_9},
		{R.id.area_7_1, R.id.area_7_2, R.id.area_7_3, R.id.area_7_4, R.id.area_7_5, R.id.area_7_6, R.id.area_7_7, R.id.area_7_8, R.id.area_7_9},
		{R.id.area_8_1, R.id.area_8_2, R.id.area_8_3, R.id.area_8_4, R.id.area_8_5, R.id.area_8_6, R.id.area_8_7, R.id.area_8_8, R.id.area_8_9},
		{R.id.area_9_1, R.id.area_9_2, R.id.area_9_3, R.id.area_9_4, R.id.area_9_5, R.id.area_9_6, R.id.area_9_7, R.id.area_9_8, R.id.area_9_9},
		{R.id.area_10_1, R.id.area_10_2, R.id.area_10_3, R.id.area_10_4, R.id.area_10_5, R.id.area_10_6, R.id.area_10_7, R.id.area_10_8, R.id.area_10_9}
	};
